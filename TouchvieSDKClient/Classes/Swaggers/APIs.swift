...
public class TouchvieSDKClientAPI {
    public static var basePath = "https://api1.touchvie.com"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(TouchvieSDKClientAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = TouchvieSDKClientAPI.credential
        return self
    }
}
